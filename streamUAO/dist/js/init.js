...
var splasher = function(){
	...
	$(document).on('click', '#open_right_sidebar', function (e) {
		$("#row-video-espectador").css("width", "95%");
	...
	$(document).on("keypress","#input_msg_send",function (e) {
		...
		if ((e.which == 13)&&(!$(this).val().length == 0)) {
			...
			//$('<li class="self mb-10"><div class="self-msg-wrap"><div class="msg block pull-right">' + $(this).val() + '<div class="msg-per-detail mt-5"><span class="msg-time txt-grey">3:30 pm</span></div></div></div><div class="clearfix"></div></li>').insertAfter("#mensajeChat  ul li:last-child");
			$(this).val('');
		} else if(e.which == 13) {
			alert('Please type somthing!');
		}
